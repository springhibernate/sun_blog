...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, :user_info => {:user_name=>"user1",:password_ori=>"123456",:password_ori_confirm=>"123456"}
    end
  ...
  test "should update user_info" do
    put :update, :id => @user_info.to_param, :user_info =>{
        :user_name=>@user_info.user_name,
        :password_ori=>"456789",
        :password_ori_confirm=>"456789"
    }
    assert_redirected_to user_infos_url
  end
